...
let gradient_checkbox = document.querySelector("#gradientCB");
let bars_checkbox = document.querySelector("#barsCB");
let circles_checkbox = document.querySelector("#circlesCB");
